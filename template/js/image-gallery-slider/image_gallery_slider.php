...
<div id="jssor_1" style="position: relative; margin: 0; top: 0px; left: 0px; width: 600px; height: 300px; overflow: hidden; visibility: hidden;">
    <!-- Loading Screen -->
    ...
    <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 600px; height: 300px; overflow: hidden;">
        <?php foreach($images as $imagePath):?>
            <?php if($imagePath==null) continue;?>
        <div data-p="112.50" style="display: none;">
            <img data-u="image" src="<?=$imagePath?>" />
            <img data-u="thumb" src="<?=$imagePath?>" />
        </div>
        <?php endforeach;?>
